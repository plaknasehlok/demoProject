...
public class User_Profiles implements Serializable {
	...
	public void setMobile_no(final long mobile_no) {
	...
	public User_Profiles(Integer user_profile_id, String aadhar_no, String f_name, String l_name, String m_name,String fathers_name, long mobile_no, String email_id, Date dob, String res_addr, String per_addr,String occ_details,int status) {
